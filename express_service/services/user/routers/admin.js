...
adminRouter.get("/candidates/condition", auth, transport.listCandidatesByCondition);
adminRouter.get("/candidates/:id", auth, transport.candidateInfo);
adminRouter.get("/candidates", auth, transport.listCandidates);

adminRouter.get("/employers/condition", auth, transport.listEmployersByCondition);
