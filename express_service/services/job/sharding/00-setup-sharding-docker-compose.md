...
rs.initiate({
  _id: "shard1rs",
  members: [
    { _id: 0, host: "shard1server1:27017" },
    { _id: 1, host: "shard1server2:27017" },
    { _id: 2, host: "shard1server3:27017" }
  ]
})
rs.status()
```
...
rs.initiate({
  ...
  members: [
    ...
    { _id: 2, host: "shard2server3:27017" }
  ]
})
rs.status()
```
...
sh.addShard("shard1rs/shard1server1:27017,shard1server2:27017,shard1server3:27017")
sh.addShard("shard2rs/shard2server1:27017,shard2server2:27017,shard2server3:27017")
